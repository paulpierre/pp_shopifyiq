...
jQuery.fn.showLoading = function(options) {
    ...
    if(typeof $("#progress-bar-container") != undefined)$("#product-container").append('<div id="progress-bar-container"><span id="loading-text">...Loading your shit</span><br/><br/><div id="progress-bar"></div>');
...
jQuery.fn.hideLoading = function(options) {
    ...
    if(typeof $("#progress-bar-container") != undefined)$("#progress-bar-container").remove();
